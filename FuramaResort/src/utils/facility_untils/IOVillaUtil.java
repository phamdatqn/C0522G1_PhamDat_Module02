...
public class IOVillaUtil extends IOFileUtil {
    ...
    public static Map<Villa, Integer> readVilla(String path) {
        ...
        for (String item : data) {
            ...
            villaIntegerMap.put(new Villa(arrProperty[0], arrProperty[1], Double.parseDouble(arrProperty[2].trim()),
                    ...
                    Double.parseDouble(arrProperty[8].trim())), Integer.parseInt(arrProperty[9]));
        }
